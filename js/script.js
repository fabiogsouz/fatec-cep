...
async function consultarCep() {
    //obtendo valor do cep no formulário
    ...
    if (!cep || cep.length < 8) { //se não exisir ou se o tamanho for menor que 8
        ...
        if (dadosCep.erro) {
            resultadoCep.textContent = '❌ Erro ao consultar CEP informado'
            return
        }
